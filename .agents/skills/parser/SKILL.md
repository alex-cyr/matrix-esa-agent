...
7. **Client Proposal / Engagement Letter:**
   Scan for the proposal PDF. Extract the Project Number exactly as written. Extract the individual's Full Name entirely separate from the Company Name. Extract the Client Mailing Address. Furthermore, explicitly extract the exact "Proposal Date" and "Approval Date" to pass to the Template Compiler.
